...
public class FragmentTab4BindingImpl extends FragmentTab4Binding  {
    ...
    public FragmentTab4BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentTab4BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.tq.startup.tabbedactivity.viewmodel.Tab4ViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.tq.startup.tabbedactivity.viewmodel.Tab4ViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.tq.startup.tabbedactivity.viewmodel.Tab4ViewModel viewModel = mViewModel;

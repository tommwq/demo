...
public class Util {
    ...
    public static <T> T call(FallibleFunction<T> function, FallibleMapper<Throwable, T> errorHandler) {
        try {
    ...
    public static <T> T call(FallibleFunction<T> function, T defaultValue) {
        try {
            return function.call();
        } catch (Exception error) {
            return defaultValue;
    ...
    public static <T> T call(FallibleFunction<T> function) {
        return call(function, (T) null);
    }

//  public static <T> void run(FallibleProcedure<T> procedure, T... args) {
//    run(null, procedure, args);
//  }

//  public static <T> void run(FallibleProcedure<Throwable> errorHandler, FallibleProcedure<T> procedure, T... args) {
//    try {
//      procedure.call(args);
//    } catch (Exception error) {
//      if (errorHandler == null) {
...
//  }
    ...
    public static URL fileNameToUrl(String fileName) {
        return call(() -> new File(fileName).toURI().toURL());
    }
    ...
    public static <T> void abortOnError(FallibleProcedure procedure) {
        try {
            procedure.call();
        } catch (Exception e) {
    ...
    public static void ignoreError(final FallibleProcedure routine) {
        try {
            routine.call();
        } catch (Exception e) {
            // ignore

...
public class TransmitServiceSourceCodeGenerator {
  ...
  public static class Builder {
    ...
    public TransmitServiceSourceCodeGenerator build() {
      return new TransmitServiceSourceCodeGenerator(config);
    }
  }

  private Config config;
  private TransmitServiceSourceCodeGenerator(Config aConfig) {
    config = aConfig;
  }
